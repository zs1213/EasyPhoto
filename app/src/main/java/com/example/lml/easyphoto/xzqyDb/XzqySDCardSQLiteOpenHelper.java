...
public abstract class XzqySDCardSQLiteOpenHelper {
	private static final String TAG = XzqySDCardSQLiteOpenHelper.class.getSimpleName();
	 ...
	 */
	public XzqySDCardSQLiteOpenHelper(Context context, String name,
			...
			if (version != mNewVersion) {
				...
				try {
					...
					if(mNewVersion>=version){
						...
						Toast.makeText(mContext, "该版本非最新版本，请更新软件！", Toast.LENGTH_LONG).show();
					}
