...
public abstract class MapSDCardSQLiteOpenHelper {
	private static final String TAG = MapSDCardSQLiteOpenHelper.class.getSimpleName();
	 ...
	 */
	public MapSDCardSQLiteOpenHelper(Context context, String name,
