...
public class PhotoMain extends Activity implements View.OnClickListener {
    ...
    private int chooseFlag = 0;//0：叠加图 1 灾评图  2 影像
...
//        ArcGISRuntimeEnvironment.setLicense("runtimelite,1000,rud4449636536,none,NKMFA0PL4S0DRJE15166");
    ...
    private void addMarker(MotionEvent e) {
        ...
        SearchService.getInstance().getMap4Server(featureTable, pointGps, new SearchService.MapCallBack() {
            ...
            public void onFailure(Exception e) {
                Toast.makeText(PhotoMain.this, "未查到行政区域数据", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        ...
        switch (v.getId()) {
            ...
            case R.id.camera_choose:
                ...
                if (chooseFlag==0){
                    ...
                    btn_choose.setText("影像图");
                }else {
                    chooseFlag =0;
                    map.getBasemap().getBaseLayers().get(0).setVisible(true);
                    map.getOperationalLayers().get(0).setVisible(true);
                    btn_choose.setText("叠加图");
                }
                break;
                ...
                public void onResponse(String json) {
                    try {
                        ...
                        if (code == 0) {
                            ...
                            progressDialog1.dismiss();
                            if ((subNumber+subFailNumber) == size) {
                                Toast.makeText(PhotoMain.this, "图片提交完成，成功："+subNumber+",失败："+subFailNumber, Toast.LENGTH_SHORT).show();
                                if (progressDialog1.isShowing()) {
                                    progressDialog1.dismiss();
                                }
                                photoBeanList = service.getPhotoList();
    ...
    private void setting() {
        ...
        et_beizhu.setText("");
        et_crop.setOnTouchListener(new GetSingleSelectItem(PhotoMain.this, et_crop, "种植作物", crop, false));
        et_taskIf.setOnTouchListener(new GetSingleSelectItem(PhotoMain.this, et_taskIf, "任务照", taskIf, false));
        ...
        et_massifType.setOnTouchListener(new GetSingleSelectItem(PhotoMain.this, et_massifType, "地块类型", massifType, false));
        et_chuping.setOnTouchListener(new GetSingleSelectItem(PhotoMain.this, et_chuping, "初评符合", chuping, false));
        et_soilType.setOnTouchListener(new GetSingleSelectItem(PhotoMain.this, et_soilType, "土壤类型", soilType, false));
